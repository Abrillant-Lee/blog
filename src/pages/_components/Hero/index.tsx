...
function Name() {
  return (
    ...
    >
      ...
      >
        <Translate id="homepage.hero.name">nan</Translate>
      </span>
      ...
      <div className={styles.intro}>
        ...
        <motion.p custom={2} initial="hidden" animate="visible" variants={variants}>
          <Translate id="homepage.hero.text">
            {`主动学习新知识，让头脑始终保持在开放和前沿的状态。在这里我会分享各类技术栈所遇到问题与解决方案，带你了解最新的技术栈以及实际开发中如何应用，并希望我的开发经历对你有所启发。`}
          </Translate>
        </motion.p>
        ...
        >
          <div className={styles.outer}>
            ...
            <a className={styles.button} href={'https://abrillant-lee.github.io/resume'}>
